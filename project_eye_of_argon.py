...
p.challenges.append(challenge_object('The numbers of words in the Eye of Argon is larger than 10,000, which could slow down performance.', 'The words were sorted alphabetically, with duplicates removed, and words with fewer than three letters removed.', 'Resolved'))
